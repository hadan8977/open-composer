...
- 状态：**done — 被否定**（2026-09-16 10:30 UTC，四个门全部命中停止条件；状态由 Fable 依据 `reports/research/lessons/L-20260916-01.md` 翻转，执行者未改预登记）· 假设族：insider_form4_gate（用 4 / 预算 6，剩余 2 已封）
