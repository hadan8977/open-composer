...
- 状态：暂停 / on hold（2026-09-21 口径复核；2026-09-18 的旧状态不代表现已可训练）· 假设族：ml_ranking_broad（与 H-20260917-02 同族，合计预算 6）· 前置依赖：D-20260917-01（宽池子）、Alpha158 等因子表在宽池子上重建、标签/成交/特征语义核对
