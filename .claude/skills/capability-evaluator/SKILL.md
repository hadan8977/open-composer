...
6. Check provider timeframe support and strict behavior before marking a capability paper-ready.
7. Treat sample, fixture, cache fallback, and trial/research-only data as workflow or research evidence, not paper-ready market evidence.
