...
Follow the [local skill map](../impeccable/reference/skill-map.md). Impeccable leads broad discovery, reference research, concept selection, and review. Search results are recommendations within the selected brief, not rules that replace the product's identity. Existing project tokens remain authoritative during refinements.
