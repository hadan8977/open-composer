...
def test_candidate_metrics_consume_primary_twenty_bps_benchmarks(monkeypatch) -> None:
    ...
    def fake_promotion_metrics(**kwargs):
        ...
        return {
            ...
            "qqq_upside_capture": 1.0,
            "qqq_downside_capture": 0.0,
            "qqq_capture_ratio": 1.0,
            "qqq_correlation": 1.0,
            "max_drawdown": 0.0,
            "mar": 1.0,
...
def test_development_dsr_is_an_individual_advance_gate() -> None:
    ...
    metrics = {
        ...
        "qqq_upside_capture": 2.6,
        "qqq_downside_capture": 0.9,
        "qqq_capture_ratio": 2.9,
        "qqq_correlation": 0.9,
        "max_drawdown": -0.60,
        "mar": 0.50,
